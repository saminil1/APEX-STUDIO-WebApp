...
> 위치: ~/APEX-STUDIO-WebApp/CLAUDE.md
> 작성일: 2026-02-24
...
| 파일명 | 설명 |
| --- | --- |
| APEX-STUDIO_01_Requirements.docx | 요구사항정의서 |
| APEX-STUDIO_02_TechSpec.docx | 기술사양정의서 |
| APEX-STUDIO_03_ContextPrompt.docx | 착수 Context 프롬프트 |
| APEX-STUDIO_04_CLAUDE_md.docx | CLAUDE.md 원본 (Word) |
| 01_claude_code_prompts.md | Claude Code 프롬프트 모음 |
| 02_brand_customization.md | 브랜드 커스터마이징 가이드 |
| 03_domain_hosting_guide.md | 도메인/호스팅 가이드 |
